#ifndef __HOLYDBG_SRC_BINFMT_ELF_FROM_IMAGE_ELF_IMAGE_HPP__
#define __HOLYDBG_SRC_BINFMT_ELF_FROM_IMAGE_ELF_IMAGE_HPP__
...
#endif // __HOLYDBG_SRC_BINFMT_ELF_FROM_IMAGE_ELF_IMAGE_HPP__
