...
#endif
{
	...
	*usedInstructionsCount = 0;
	...
	return decode_internal(ci, DISTORM_FALSE, result, maxInstructions, usedInstructionsCount);
}
		...
		switch (di->ops[i].type)
		{
			...
			case O_SMEM:
				...
				switch (di->opcode)
				{
					...
					case I_LODS:
					case I_STOS:
					case I_SCAS: isDefault = DISTORM_FALSE; break;
				}
...
#endif
{
	...
	*usedInstructionsCount = 0;
	...
	res = decode_internal(&ci, DISTORM_TRUE, (_DInst*)result, maxInstructions, &instsCount);
