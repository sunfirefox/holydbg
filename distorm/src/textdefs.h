...
DISTORM_FASTCALL void str_hex_b(_WString* s, unsigned int x);
DISTORM_FASTCALL void str_code_hb(_WString* s, unsigned int x);
DISTORM_FASTCALL void str_code_hdw(_WString* s, uint32_t x);
DISTORM_FASTCALL void str_code_hqw(_WString* s, uint8_t src[8]);

#ifdef DISTORM_SUPPORT_64BIT_OFFSET
  DISTORM_FASTCALL void str_off64(_WString* s, OFFSET_INTEGER x);
#endif
